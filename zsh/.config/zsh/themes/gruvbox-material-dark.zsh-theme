...
###### ElEMENTS
  ...
  if (( ${PURE_POWER_USE_P10K_EXTENSIONS:-1} )); then
    ...
    if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
      typeset -g POWERLEVEL9K_RULER_FOREGROUND='#3c3836'
    else
...
### folders  
    ...
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#7daea3'
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#a9b665'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#ea6962'
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#d8a657'
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#3c3836'
  else
